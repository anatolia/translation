...
namespace Translation.Tests.TestHelpers
{
    ...
    {
        public const long IdCurrentUser = 4198161609L;

        public const long IdParkNet = 8168161649L;
        public static Guid UidParkNet => new Guid("d59f0cf5-b347-4c1e-883a-af2fd4333459");
        public const string NameParkNet = "ParkNet";

        public const long IdParkNetProjectOne = 1167161649L;
        public static Guid UidParkNetProjectOne => new Guid("7f062647-4c7d-4ba5-b380-55869c74a944");
        public const string NameParkNetProjectOne = "ParkNet Project One";

        public const long IdBlueSoft = 5168064649L;
        public static Guid UidBlueSoft => new Guid("bead3ad6-dc3c-44cd-9031-ad09438877f1");
        public const string NameBlueSoft = "BlueSoft";

        public const long IdBlueSoftProjectOne = 2157161649L;
        public static Guid UidBlueSoftProjectOne => new Guid("c67d7fa4-5626-4777-a591-ded84dc76e50");
        public const string NameBlueSoftProjectOne = "BlueSoft Project One";

        public static Guid UidEmpty => Guid.Empty;
