...
namespace Translation.Tests.SetupHelpers
{
    ...
    {
        //public static void Setup_GetIntegrationList_Returns_IntegrationReadListResponse_Success(this Mock<IIntegrationService> service)
        //{
        //    service.Setup(x => x.GetIntegrationList(It.IsAny<IntegrationReadListRequest>()))
        ...
        public static void Setup_ChangeActivationForIntegrationClient_Returns_IntegrationClientChangeActivationResponse_Success(this Mock<IIntegrationService> service)
        {
            service.Setup(x =>
                ...
                .Returns(Task.FromResult(
                    new IntegrationClientChangeActivationResponse { Status = ResponseStatus.Success }));
        }

        //public static void Setup_GetIntegrationClientList_Returns_IntegrationClientReadListResponse_Success(this Mock<IIntegrationService> service)
        //{
        //    service.Setup(x => x.GetIntegrationClientList(It.IsAny<IntegrationClientReadListRequest>()))
        //        .Returns(Task.FromResult(new IntegrationClientReadListResponse { Status = ResponseStatus.Success }));
        //}
        ...
        //public static void Setup_GetAllActiveTokenList_Returns_AllActiveTokenReadListResponse_Success(this Mock<IIntegrationService> service)
        //{
        //    service.Setup(x => x.GetAllActiveTokenList(It.IsAny<AllActiveTokenReadListRequest>()))
        //        .Returns(Task.FromResult(new AllActiveTokenReadListResponse { Status = ResponseStatus.Success }));
        //}
        ...
        public static void Setup_GetActiveTokensOfOrganization_Returns_OrganizationActiveTokenReadListResponse_Success(this Mock<IIntegrationService> service)
        {
            service.Setup(x => x.GetActiveTokensOfOrganization(It.IsAny<OrganizationActiveTokenReadListRequest>()))
                .Returns(Task.FromResult(
                    new OrganizationActiveTokenReadListResponse { Status = ResponseStatus.Success }));
        }
        ...
        public static void Setup_GetActiveTokensOfIntegrationClient_Returns_IntegrationClientActiveTokenReadListResponse_Success(this Mock<IIntegrationService> service)
        {
            service.Setup(x =>
                ...
                .Returns(
                    Task.FromResult(
                        new IntegrationClientActiveTokenReadListResponse { Status = ResponseStatus.Success }));
        }
        ...
        {
            service
                .Setup(x => x.GetTokenRequestLogsOfIntegration(It.IsAny<IntegrationTokenRequestLogReadListRequest>()))
                .Returns(Task.FromResult(
                    new IntegrationTokenRequestLogReadListResponse { Status = ResponseStatus.Success }));
        }
        ...
        {
            service.Setup(x =>
                    x.GetTokenRequestLogsOfIntegrationClient(
                        It.IsAny<IntegrationClientTokenRequestLogReadListRequest>()))
                .Returns(Task.FromResult(
                    new IntegrationClientTokenRequestLogReadListResponse { Status = ResponseStatus.Success }));
        }

        //public static void Setup_GetIntegrationList_Returns_IntegrationReadListResponse_Failed(this Mock<IIntegrationService> service)
        //{
        //    service.Setup(x => x.GetIntegrationList(It.IsAny<IntegrationReadListRequest>()))
        ...
        public static void Setup_ChangeActivationForIntegrationClient_Returns_IntegrationClientChangeActivationResponse_Failed(this Mock<IIntegrationService> service)
        {
            service.Setup(x =>
                    x.ChangeActivationForIntegrationClient(It.IsAny<IntegrationClientChangeActivationRequest>()))
                .Returns(
                    Task.FromResult(new IntegrationClientChangeActivationResponse { Status = ResponseStatus.Failed, ErrorMessages = new List<string> { StringOne } }));
        }

        //public static void Setup_GetIntegrationClientList_Returns_IntegrationClientReadListResponse_Failed(this Mock<IIntegrationService> service)
        //{
        //    service.Setup(x => x.GetIntegrationClientList(It.IsAny<IntegrationClientReadListRequest>()))
        //        .Returns(Task.FromResult(new IntegrationClientReadListResponse { Status = ResponseStatus.Failed, ErrorMessages = new List<string> { StringOne } }));
        //}
        ...
        //public static void Setup_GetAllActiveTokenList_Returns_AllActiveTokenReadListResponse_Failed(this Mock<IIntegrationService> service)
        //{
        //    service.Setup(x => x.GetAllActiveTokenList(It.IsAny<AllActiveTokenReadListRequest>()))
        //        .Returns(Task.FromResult(new AllActiveTokenReadListResponse { Status = ResponseStatus.Failed, ErrorMessages = new List<string> { StringOne } }));
        //}
        ...
        public static void Setup_GetActiveTokensOfIntegrationClient_Returns_IntegrationClientActiveTokenReadListResponse_Failed(this Mock<IIntegrationService> service)
        {
            service.Setup(x =>
                    x.GetActiveTokensOfIntegrationClient(It.IsAny<IntegrationClientActiveTokenReadListRequest>()))
                .Returns(Task.FromResult(
                    new IntegrationClientActiveTokenReadListResponse { Status = ResponseStatus.Failed, ErrorMessages = new List<string> { StringOne } }));
        }
        ...
        public static void Setup_GetTokenRequestLogsOfIntegration_Returns_IntegrationTokenRequestLogReadListResponse_Failed(this Mock<IIntegrationService> service)
        {
            service
                .Setup(x => x.GetTokenRequestLogsOfIntegration(It.IsAny<IntegrationTokenRequestLogReadListRequest>()))
                .Returns(Task.FromResult(
                    new IntegrationTokenRequestLogReadListResponse { Status = ResponseStatus.Failed, ErrorMessages = new List<string> { StringOne } }));
        }
        ...
        public static void Setup_GetTokenRequestLogsOfIntegrationClient_Returns_IntegrationClientTokenRequestLogReadListResponse_Failed(this Mock<IIntegrationService> service)
        {
            service.Setup(x =>
                    x.GetTokenRequestLogsOfIntegrationClient(
                        It.IsAny<IntegrationClientTokenRequestLogReadListRequest>()))
                .Returns(Task.FromResult(
                    new IntegrationClientTokenRequestLogReadListResponse { Status = ResponseStatus.Failed, ErrorMessages = new List<string> { StringOne } }));
        }

        //public static void Setup_GetIntegrationList_Returns_IntegrationReadListResponse_Invalid(this Mock<IIntegrationService> service)
        //{
        //    service.Setup(x => x.GetIntegrationList(It.IsAny<IntegrationReadListRequest>()))
        ...
        //public static void Setup_GetIntegrationClientList_Returns_IntegrationClientReadListResponse_Invalid(this Mock<IIntegrationService> service)
        //{
        //    service.Setup(x => x.GetIntegrationClientList(It.IsAny<IntegrationClientReadListRequest>()))
        //        .Returns(Task.FromResult(new IntegrationClientReadListResponse { Status = ResponseStatus.Invalid, ErrorMessages = new List<string> { StringOne } }));
        //}
        ...
        //public static void Setup_GetAllActiveTokenList_Returns_AllActiveTokenReadListResponse_Invalid(this Mock<IIntegrationService> service)
        //{
        //    service.Setup(x => x.GetAllActiveTokenList(It.IsAny<AllActiveTokenReadListRequest>()))
        //        .Returns(Task.FromResult(new AllActiveTokenReadListResponse { Status = ResponseStatus.Invalid, ErrorMessages = new List<string> { StringOne } }));
        //}
        ...
        public static void Setup_GetTokenRequestLogsOfIntegration_Returns_IntegrationTokenRequestLogReadListResponse_Invalid(this Mock<IIntegrationService> service)
        {
            service
                .Setup(x => x.GetTokenRequestLogsOfIntegration(It.IsAny<IntegrationTokenRequestLogReadListRequest>()))
                .Returns(Task.FromResult(
                    new IntegrationTokenRequestLogReadListResponse { Status = ResponseStatus.Invalid, ErrorMessages = new List<string> { StringOne } }));
        }
        ...
        public static void Setup_GetTokenRequestLogsOfIntegrationClient_Returns_IntegrationClientTokenRequestLogReadListResponse_Invalid(this Mock<IIntegrationService> service)
        {
            service.Setup(x =>
                    x.GetTokenRequestLogsOfIntegrationClient(
                        It.IsAny<IntegrationClientTokenRequestLogReadListRequest>()))
                .Returns(Task.FromResult(
                    new IntegrationClientTokenRequestLogReadListResponse { Status = ResponseStatus.Invalid, ErrorMessages = new List<string> { StringOne } }));
        }

        //public static void Verify_GetIntegrationList(this Mock<IIntegrationService> service)
        //{
        //    service.Setup(x => x.GetIntegrationList(It.IsAny<IntegrationReadListRequest>()));
        //}
        ...
        //public static void Verify_GetIntegrationClientList(this Mock<IIntegrationService> service)
        //{
        //    service.Setup(x => x.GetIntegrationClientList(It.IsAny<IntegrationClientReadListRequest>()));
        //}
        ...
        //public static void Verify_GetAllActiveTokenList(this Mock<IIntegrationService> service)
        //{
        //    service.Setup(x => x.GetAllActiveTokenList(It.IsAny<AllActiveTokenReadListRequest>()));
        //}
