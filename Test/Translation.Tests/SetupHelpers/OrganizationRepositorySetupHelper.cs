...
namespace Translation.Tests.SetupHelpers
{
    public static class OrganizationRepositorySetupHelper
    {
        ...
        public static void Setup_Any_Returns_False(this Mock<IOrganizationRepository> repository)
            ...
            {
                repository.Setup(x => x.Count(It.IsAny<Expression<Func<Organization, bool>>>(), It.IsAny<bool>()))
                    .ReturnsAsync(Ten);
            }
            ...
            //todo:
            //public static void Setup_SelectMany_Returns_OrganizationList(this Mock<IOrganizationRepository> repository)
            //{
            ...
            //        .ReturnsAsync(TranslationEntityDataHelper.GetFakeParkNetOrganizationList());
            //}
            ...
            //public static void Setup_SelectAfter_Returns_OrganizationList(this Mock<IOrganizationRepository> repository)
            //{
