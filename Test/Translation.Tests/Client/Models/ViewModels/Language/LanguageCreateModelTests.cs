...
namespace Translation.Tests.Client.Models.ViewModels.Language
{
    ...
    public class LanguageCreateModelTests
    {
        ...
        public void IntegrationCreateModel_SetInputModelValues()
        {
            ...
            // assert
            SystemUnderTest.NameInput.Value.ShouldBe(SystemUnderTest.Name.TrimOrDefault());
            SystemUnderTest.OriginalNameInput.Value.ShouldBe(SystemUnderTest.OriginalName.TrimOrDefault());
